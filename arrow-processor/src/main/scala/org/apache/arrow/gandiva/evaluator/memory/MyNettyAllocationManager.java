...
package org.apache.arrow.gandiva.evaluator.memory;
 ...
 */
public class MyNettyAllocationManager extends AllocationManager {

  public static final Factory FACTORY = new MyFactory();
  ...
  MyNettyAllocationManager(BaseAllocator accountingAllocator, int requestedSize) {
  ...
  /**
   * Factory for creating {@link MyNettyAllocationManager}.
   */
  public static class MyFactory implements AllocationManager.Factory {
    private MyFactory() {}

    @Override
    public AllocationManager create(BaseAllocator accountingAllocator, long size) {
      return new MyNettyAllocationManager(accountingAllocator, LargeMemoryUtil.checkedCastToInt(size));
    }
  }
}
